...
set val(nn)             140                        ;# number of mobilenodes
...
#setting new random agent

set WEN [new Agent/NHDF]

$WEN set SetValue     #setting value of random
$WEN getValue




# set up transmission range
...
$ns attach-agent $node_(6) $udp
$ns connect $udp $null

set cbr [new Application/Traffic/CBR]
$cbr attach-agent $udp

$cbr set packetSize_ 512  ######## setting packet size
$cbr set rate_ 1mb  #### setting data rate
